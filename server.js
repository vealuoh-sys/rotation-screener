...
const SECTORS = {
  ...
  'L2':        [
    ...
    'METISUSDT','SKLUSDT','LRCUSDT','NTRNUSDT','SCRUSDT'
  ],
  'DEFI':      [
  ...
  'AI_DATA':   [
    ...
    'OCEANUSDT','NMRUSDT','PHAUSDT','RNDRUSDT','TAOUSDT'
  ],
  'GAMING':    [
  ...
  'INFRA':     [
    ...
    'SCUSDT','AEROUSDT_PREMIUM','NKNUSDT','XVSUSDT','IOTAUSDT'
  ],
  'PAYMENTS':  [
  ...
  'COSMOS':    [
    ...
    'AKTUSDT','OSMOUSDT','EVMOSUSDT','STRDUSDT'
  ],
  'MEME':      [
  ...
  'EXCHANGE':  [
    'BNBUSDT','CAKEUSDT','DYDXUSDT','GTCUSDT'
  ],
  'PRIVACY':   [
    'XMRUSDT','ZECUSDT','ROSEUSDT','PHAUSDT','SCRTUSDT'
  ],
  'ORACLE':    [
    'LINKUSDT','BANDUSDT','API3USDT'
  ],
  'NFT':       [
    'ENSUSDT','RAREUSDT','SUPERUSDT','XCNUSDT_PREMIUM'
  ],
  'REAL_WORLD':[
    'RLCUSDT','COTIUSDT','ACHUSDT','REQUSDT','POLUSDT'
  ],
  'BIG_ALTS':  [
...
const SUB_NARRATIVE = {
  // Cosmos ecosystem
  COSMOS_ECO: ['ATOMUSDT','TIAUSDT','INJUSDT','AKTUSDT','OSMOUSDT','STRDUSDT','NTRNUSDT','EVMOSUSDT'],
  // Ethereum L2
  ETH_L2:     ['MATICUSDT','ARBUSDT','OPUSDT','METISUSDT','SKLUSDT','LRCUSDT','IMXUSDT','SCRUSDT'],
...
const CAP_TIER = {
  ...
  STORJUSDT:5, SCUSDT:5, AEROUSDT_PREMIUM:5, NKNUSDT:5, IOTAUSDT:5,
  ...
  SUPERUSDT:5, XCNUSDT_PREMIUM:5, SCRUSDT:5,
};
